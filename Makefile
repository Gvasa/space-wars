...
# Specify libraries.
LIBRARIES = -lenet -lwinmm -losgbDynamics -losgbCollision -losgbInteraction -losg -losgUtil -losgDB -losgGA -losgViewer -losgFX -losgText -lsgct -lopengl32 -lglu32 -lgdi32 -lws2_32 -lBulletDynamics -lBulletCollision -lLinearMath -lBulletSoftBody
